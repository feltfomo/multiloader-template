...
data class ModConfig(
  ...
  val hasAccessWideners: Boolean
    get() = accessTransformerText.isNotBlank()
    ...
    fun load(modPkl: File): ModConfig =
        Evaluator.preconfigured().use { evaluator ->
          ...
          ModConfig(
              ...
              fabricApiVersion = module.get("fabricApiVersion") as String,
              datagen = module.get("datagen") as Boolean,
