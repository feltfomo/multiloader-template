...
Minecraft 26.1.2, Java 25, Gradle 9.4.1 (wrapper), Fabric Loom, NeoForge moddev, Pkl. Kotlin and Scala are wired in as examples of mixed-language common code; both ride along in the built jar.
